...
class TestComponent extends Component {
  ...
  handleTestUpdateProfile = async () => {
    ...
    let userDocRef = await firestore
      .collection("users")
      .doc("5dSa2Up7fOQXLotnAOWUSy06jcn2");
    try {
  ...
  handleTestJoinEvent = async () => {
    ...
    try {
      await eventDocRef.update({
        [`attendees.5dSa2Up7fOQXLotnAOWUSy06jcn2`]: attendee
      });
      toastr.success("Success");
    } catch (error) {
      console.log(error);
  ...
  handleTestCancelGoingToEvent = async () => {
    ...
    try {
      await eventDocRef.update({
        [`attendees.5dSa2Up7fOQXLotnAOWUSy06jcn2`]: firebase.firestore.FieldValue.delete()
      });
      toastr.success("Success");
    } catch (error) {
      console.log(error);
  ...
  handleTestChangeAttendeePhotoInEvent = async () => {
    ...
    try {
      await eventDocRef.update({
        [`attendees.5dSa2Up7fOQXLotnAOWUSy06jcn2.photoURL`]: "testing123.jpg"
      });
      toastr.success("Success");
    } catch (error) {
      console.log(error);
